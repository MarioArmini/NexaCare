...
using Relic.Database.Seed;
using Relic.Host.Managers;
using Relic.Host.ObjectMapper;
using Relic.Host.Services.Addresses;
using Relic.Host.Services.Auth;
using Relic.Host.Services.Interfaces;
using Relic.Host.Services.Mails;
using Relic.Host.Services.Users;
...
builder.Services
    ...
    .AddEntityFrameworkStores<RelicDbContext>()
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Relic API", Version = "v1" });
